  ...
  return (
    <div className="h-screen relative overflow-hidden" id="home">
      ...
      <div className="hero-content container mx-auto px-4 text-center text-white z-10 relative h-full flex flex-col justify-center transition-opacity duration-500">
        <h1
          className="text-5xl md:text-6xl lg:text-7xl font-serif font-bold mb-6 text-shadow-lg animate-slide-in-top opacity-0"
        ...
        <p
          className="text-xl md:text-2xl max-w-3xl mx-auto mb-8 text-shadow animate-slide-in-top opacity-0"
        ...
        <div className="flex justify-center">
          <a
            href="#destinations"
            className="bg-majestic-gold hover:bg-majestic-amber text-white px-8 py-3 rounded-full text-lg font-medium transition-all duration-300 hover:shadow-lg hover:scale-105 animate-slide-in-top opacity-0"
      ...
      <button
        ...
        className="absolute bottom-10 left-1/2 transform -translate-x-1/2 text-white animate-bounce z-10 opacity-0"
