...
export const destinationDetails: DestinationDetail[] = [
  {
    ...
    bestTimeToVisit: "The best time to visit Tiger's Nest is during spring (March-May) and autumn (September-November) when the weather is pleasant and skies are clear, offering the best views during the hike.",
    howToReach: "The monastery is located about 10 km north of Paro. Visitors can take a taxi or arrange transportation through their hotel to the base of the mountain. From there, it's a 2-3 hour uphill hike to reach the monastery. Horses are available for hire for part of the journey."
  },
  {
    id: 2,
    name: "Punakha Dzong",
    ...
    bestTimeToVisit: "Visit during spring (March-April) when the jacaranda trees bloom with purple flowers, creating a magical setting around the dzong. The winter months (November-February) offer clear views with fewer tourists.",
    howToReach: "Punakha is approximately a 2.5-hour drive from Thimphu. The dzong is located at the confluence of Mo Chhu and Pho Chhu rivers, easily accessible by road. Most tours include transportation, or taxis can be arranged from major towns."
  },
  {
    id: 3,
    name: "Dochula Pass",
    ...
    bestTimeToVisit: "October to February offers the clearest views of the Himalayan peaks. Early morning visits are recommended to avoid clouds that typically form by midday.",
    howToReach: "Dochula Pass is located approximately 30 km from Thimphu on the way to Punakha. It takes about 45 minutes to drive from Thimphu, and the pass is a common stop on journeys between Thimphu and Punakha."
  },
  {
    id: 4,
    ...
    bestTimeToVisit: "November to February to witness the black-necked cranes. The valley is also beautiful during spring (March-May) when wildflowers bloom across the meadows.",
    howToReach: "Phobjikha Valley is located about 3 hours east of Punakha (approximately 5-6 hours from Thimphu). The drive includes scenic mountain passes and landscapes. Most visitors arrive as part of organized tours or with private vehicles."
  }
];
